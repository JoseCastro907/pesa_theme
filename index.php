                    ...
                    <div class="col-10 col-md" style="padding-bottom: 114px;">
                        <div class="hero-paragraph">
                            <div class="align-middle h-100 mb-3">
                                ...
                                <button class="btn btn-light mt-4" style="font-weight: 600" aria-label="true"> Saber mas</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row d-flex justify-content-evenly">
                ...
                <div class="col-7 col-md-5 col-lg-2 ml-auto mr-auto card-price">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="https://dev-tm7200.pantheonsite.io/product/marketing-social-media/"> <button type="button" aria-label="true" class="btn btnContact">Comprar ahora</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-7 col-md-5 col-lg-2 ml-auto mr-auto card-price">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="https://dev-tm7200.pantheonsite.io/product/desarrollo-aplicacion-movil/"> <button type="button" aria-label="true" class="btn btnContact">Comprar ahora</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-7 col-md-5 col-lg-2 ml-auto mr-auto card-price">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="https://dev-tm7200.pantheonsite.io/product/desarrollo-tienda-online/   "> <button type="button" aria-label="true" class="btn btnContact">Comprar ahora</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-7 col-md-5 col-lg-2 ml-auto mr-auto card-price">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="#tienda"> <button type="button" aria-label="true" class="btn btnContact">Comprar ahora</button></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-center text-center">
        <div class="col-md-10">
            ...
            <div class="boton-contacto pt-5 pb-5 text-center">
                <button class="btn btn-light pt-2 pb-2 " aria-label="true" style="font-weight: 600" type="button">Saber mas</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid pt-5 pb-5" id="contacto">
    ...
    <div class="boton-contacto pt-5 pb-5 text-center">
        <button class="btn btn-light pt-2 pb-2" style="font-weight: 600" type="button" aria-label="true" id="get_in_touch">Ponte en
